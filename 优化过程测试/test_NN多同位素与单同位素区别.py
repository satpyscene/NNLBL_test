...
def compare_hapi_outputs(old_file_path, new_file_path):
    ...
    # 上图：两条曲线叠加
    ax1.plot(x_axis, old_data, label="Old (PYTIPS)", alpha=0.8)
    ax1.plot(x_axis, new_data, label="New (partitionSum)", linestyle="--", alpha=0.8)
...
compare_hapi_outputs(
    "sigma_output_filefold/CO2_600_700_0.01_101325_296_new_配分.h5",
    "sigma_output_filefold/CO2_600_700_0.01_101325_296_new配分&NN多同位素.h5",
)
